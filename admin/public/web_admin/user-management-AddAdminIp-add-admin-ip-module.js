(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["user-management-AddAdminIp-add-admin-ip-module"],{

/***/ "./node_modules/raw-loader/index.js!./src/app/Pages/Dashboard/user-management/AddAdminIp/add-admin-ip.component.html":
/*!******************************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/Pages/Dashboard/user-management/AddAdminIp/add-admin-ip.component.html ***!
  \******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<div class=\"container-fluid\">\r\n    <div class=\"row page-titles\">\r\n      <div class=\"col-md-5 align-self-center\">\r\n        <h4 class=\"text-themecolor\">{{LANG.Add_Admin}}</h4>\r\n      </div>\r\n      <div class=\"col-md-7 align-self-center text-right\">\r\n        <div class=\"d-flex justify-content-end align-items-center\">\r\n          <ol class=\"breadcrumb\">\r\n            <li class=\"breadcrumb-item\"><a href=\"javascript:void(0)\">{{LANG.Home}}</a></li>\r\n            <li class=\"breadcrumb-item active\">{{LANG.Add_Admin}}</li>\r\n          </ol>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  \r\n    <div class=\"row\">\r\n      <div class=\"col-12\">\r\n        <div class=\"card\">\r\n          <div class=\"card-body\">\r\n            <form class=\"mt-4\">\r\n              <div class=\"row\">\r\n                <div class=\"col-md-6\">\r\n                  <div class=\"form-group\">\r\n                    <label for=\"exampleInputEmail1\">{{LANG.IP}}</label>\r\n                    <input\r\n                      type=\"text\"\r\n                      class=\"form-control\"\r\n                      name=\"name\"\r\n                      placeholder=\"{{LANG.Enter_Ip}}\"\r\n                      [(ngModel)]=\"name\"\r\n                    />\r\n                    <span class=\"error\" *ngIf=\"error.name\">{{LANG.This_field_is_required}}</span>\r\n  \r\n                  </div>\r\n                </div>\r\n              </div>\r\n\r\n\r\n              <button *ngIf=\"!load\" type=\"submit\" class=\"btn btn-primary mt-2\" (click)=\"AddIp()\">{{id ? LANG.Update : LANG.Submit}}</button>\r\n              <button class=\"btn btn-primary\" *ngIf=\"load\">                                \r\n                  <loader></loader>\r\n              </button>\r\n            </form>\r\n          </div>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n  "
...
/***/ "./src/app/Pages/Dashboard/user-management/AddAdminIp/add-admin-ip.component.css":
/*!***************************************************************************************!*\
  !*** ./src/app/Pages/Dashboard/user-management/AddAdminIp/add-admin-ip.component.css ***!
  \***************************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL1BhZ2VzL0Rhc2hib2FyZC91c2VyLW1hbmFnZW1lbnQvQWRkQWRtaW5JcC9hZGQtYWRtaW4taXAuY29tcG9uZW50LmNzcyJ9 */"

/***/ }),

/***/ "./src/app/Pages/Dashboard/user-management/AddAdminIp/add-admin-ip.component.ts":
/*!**************************************************************************************!*\
  !*** ./src/app/Pages/Dashboard/user-management/AddAdminIp/add-admin-ip.component.ts ***!
  \**************************************************************************************/
/*! exports provided: AddAdminIpComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddAdminIpComponent", function() { return AddAdminIpComponent; });
...
var AddAdminIpComponent = /** @class */ (function () {
    function AddAdminIpComponent(adminService, toastr, location) {
    ...
    AddAdminIpComponent.prototype.ngOnInit = function () {
    };
    AddAdminIpComponent.prototype.errorHandler = function () {
        if (this.name == undefined || this.name == '') {
            this.error.name = true;
            this.err = true;
        }
    };
    AddAdminIpComponent.prototype.resetError = function () {
        this.err = false;
        this.load = false;
        this.error = {
            name: false
    ...
    AddAdminIpComponent.prototype.AddIp = function () {
        this.resetError();
        this.errorHandler();
        if (this.err) {
            return;
    ...
    AddAdminIpComponent.prototype.add = function (data) {
        var _this = this;
        this.adminService.addAdminIp(data).subscribe(function (res) {
            _this.load = false;
            if (res.status) {
                _this.toastr.successToastr(_this.LANG.Ip_added_successfully);
                _this.location.back();
                return;
            }
    ...
    AddAdminIpComponent.ctorParameters = function () { return [
    ...
    AddAdminIpComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-add-admin-ip',
            template: __webpack_require__(/*! raw-loader!./add-admin-ip.component.html */ "./node_modules/raw-loader/index.js!./src/app/Pages/Dashboard/user-management/AddAdminIp/add-admin-ip.component.html"),
            styles: [__webpack_require__(/*! ./add-admin-ip.component.css */ "./src/app/Pages/Dashboard/user-management/AddAdminIp/add-admin-ip.component.css")]
        }),
        __metadata("design:paramtypes", [src_app_shared_Services_user_service__WEBPACK_IMPORTED_MODULE_2__["UsersService"], ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_1__["ToastrManager"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["Location"]])
    ], AddAdminIpComponent);
    return AddAdminIpComponent;
}());
...
/*!***********************************************************************************!*\
  !*** ./src/app/Pages/Dashboard/user-management/AddAdminIp/add-admin-ip.module.ts ***!
  \***********************************************************************************/
/*! exports provided: AddAdminIpModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddAdminIpModule", function() { return AddAdminIpModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _add_admin_ip_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./add-admin-ip.component */ "./src/app/Pages/Dashboard/user-management/AddAdminIp/add-admin-ip.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChildRoutes = [
    {
        path: 'add-admin-ip',
        component: _add_admin_ip_component__WEBPACK_IMPORTED_MODULE_5__["AddAdminIpComponent"]
    },
];
var AddAdminIpModule = /** @class */ (function () {
    function AddAdminIpModule() {
    }
    AddAdminIpModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _add_admin_ip_component__WEBPACK_IMPORTED_MODULE_5__["AddAdminIpComponent"]
            ]
        })
    ], AddAdminIpModule);
    return AddAdminIpModule;
}());
...
//# sourceMappingURL=user-management-AddAdminIp-add-admin-ip-module.js.map