...
/***/ "./src/app/Pages/Dashboard/user-management/AdminIpLogs/admin-ip-log.component.css":
/*!****************************************************************************************!*\
  !*** ./src/app/Pages/Dashboard/user-management/AdminIpLogs/admin-ip-log.component.css ***!
  \****************************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL1BhZ2VzL0Rhc2hib2FyZC91c2VyLW1hbmFnZW1lbnQvQWRtaW5JcExvZ3MvYWRtaW4taXAtbG9nLmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/Pages/Dashboard/user-management/AdminIpLogs/admin-ip-log.component.ts":
/*!***************************************************************************************!*\
  !*** ./src/app/Pages/Dashboard/user-management/AdminIpLogs/admin-ip-log.component.ts ***!
  \***************************************************************************************/
/*! exports provided: AdminIpLogComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdminIpLogComponent", function() { return AdminIpLogComponent; });
...
var AdminIpLogComponent = /** @class */ (function () {
    function AdminIpLogComponent(router, userService, toast) {
        this.router = router;
    ...
    AdminIpLogComponent.prototype.ngOnInit = function () {
        this.getAdminList();
    };
    AdminIpLogComponent.prototype.addAdmin = function () {
        this.router.navigate(["/dashboard/add-admin-ip"]);
    };
    AdminIpLogComponent.prototype.getAdminList = function (type) {
        var _this = this;
        this.userService.adminIpLogList().subscribe(function (res) {
            if (res.status) {
    ...
    AdminIpLogComponent.prototype.edit = function (data) {
        this.router.navigate(["/dashboard/add-info-type"], { queryParams: { id: btoa(btoa(data.id)) } });
    };
    AdminIpLogComponent.prototype.showDeleteModal = function (data) {
        $("#delete").modal("show");
        this.delete_data = data;
    };
    AdminIpLogComponent.prototype.cancel = function () {
        this.delete_data = {};
    };
    AdminIpLogComponent.ctorParameters = function () { return [
    ...
    AdminIpLogComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-admin-ip-log',
            template: __webpack_require__(/*! raw-loader!./admin-ip-log.component.html */ "./node_modules/raw-loader/index.js!./src/app/Pages/Dashboard/user-management/AdminIpLogs/admin-ip-log.component.html"),
            styles: [__webpack_require__(/*! ./admin-ip-log.component.css */ "./src/app/Pages/Dashboard/user-management/AdminIpLogs/admin-ip-log.component.css")]
        }),
...
/*!************************************************************************************!*\
  !*** ./src/app/Pages/Dashboard/user-management/AdminIpLogs/admin-ip-log.module.ts ***!
  \************************************************************************************/
/*! exports provided: AdminIpLogsModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdminIpLogsModule", function() { return AdminIpLogsModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
/* harmony import */ var _admin_ip_log_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./admin-ip-log.component */ "./src/app/Pages/Dashboard/user-management/AdminIpLogs/admin-ip-log.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChildRoutes = [
    {
        path: 'admin-ip-logs',
        component: _admin_ip_log_component__WEBPACK_IMPORTED_MODULE_5__["AdminIpLogComponent"]
    },
];
var AdminIpLogsModule = /** @class */ (function () {
    function AdminIpLogsModule() {
    }
    AdminIpLogsModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                _admin_ip_log_component__WEBPACK_IMPORTED_MODULE_5__["AdminIpLogComponent"]
            ]
        })
    ], AdminIpLogsModule);
    return AdminIpLogsModule;
}());
...
//# sourceMappingURL=user-management-AdminIpLogs-admin-ip-log-module.js.map